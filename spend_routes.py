...
spend_bp= Blueprint('spend_bp', __name__)


# Mục tiêu tháng 
@spend_bp.route("/save-monthly", methods=['GET','POST'])
def saveMonthly():
    ...
    return jsonify(data)
# *** Mục tiêu năm *** 
@spend_bp.route("/save-year", methods=['GET','POST'])
def saveYear():
    data= request.get_json()
...
@spend_bp.route("/loading-month", methods= ['GET','POST'])
def loadMonth():
    # tạo file nếu không tồn tại 
    filePath= 'static/data/month/monthValue.json'
    os.makedirs(os.path.dirname(filePath), exist_ok= True)
...
@spend_bp.route("/loading-year", methods= ['GET', 'POST'])
def loadYear():
    filePath = 'static/data/year/yearValue.json'
    os.makedirs(os.path.dirname(filePath), exist_ok= True)
...
@spend_bp.route("/loading-year-total", methods=['GET', 'POST'])
...
@spend_bp.route("/spending", methods=['GET', 'POST'])
def addSpending():
    data= request.get_json()
...
@spend_bp.route("/spending/summary-day", methods=['GET', 'POST'])
...
@spend_bp.route("/spending/summary-month", methods=['GET', 'POST'])
...
@spend_bp.route('/char-data-day', methods=['GET', 'POST'])
...
# Month chart
@spend_bp.route('/char-data-month', methods=['GET', 'POST'])
...
@spend_bp.route('/char-data-catalog', methods=['GET', 'POST'])
...
@spend_bp.route('/spend-trans', methods=['GET', 'POST'])
def spendTrans():
    filePath = 'static/data/spend/spending.json'
    os.makedirs(os.path.dirname(filePath), exist_ok=True)
